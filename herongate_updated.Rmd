...
mpac_scaled <- qread("output/mpac_scaled.qs")
...
model_2016_value_fe <- 
  lm(value_2016 ~ rac_dis_ratio_2016 + non_perm_ratio_2016 + income_2016 + 
       ...
       ph_dist + poverty_2016 + rent_2016 + rented_2016 + city - 1, 
     data = CT_scaled)
